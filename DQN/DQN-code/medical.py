...
class MedicalPlayer(gym.Env):
    ...
    def __init__(self, directory=None, viz=False, task=False, files_list=None,
        ...
        if self.task == 'play':
            self.files = myfilesList(files_list,landmark_index,
    ...
    def display(self, return_rgb_array=False,zoom=2):
        # pass
        # get dimensions
        ...
        self.viewer.display_text('Agent ', color=(255, 0, 255, 255),
        ...
        if (self.task != 'play'):
            ...
            self.viewer.display_text(text, color=color, x=0, y=0)
