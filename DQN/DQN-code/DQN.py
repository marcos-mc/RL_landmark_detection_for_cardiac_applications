...
def get_config(files_list,landmark_index):
    """This is only used during training."""
    expreplay = ExpReplay(
        predictor_io_names=(['state'], ['Qvalue']),
        player=get_player(task='train', files_list=files_list,landmark_ind = landmark_index),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--landmark', type=int, help='index of current landmark to be used',
                        default=0)
    parser.add_argument('--csv_name', type=str, help='name of the csv file to save the results',
                        default=None)
    ...
    init_player = MedicalPlayer(files_list=args.files,
                                ...
                                task='play',landmark_index = args.landmark)
    ...
    if args.task != 'train':
        ...
        if args.csv_name:
            ...
            print('Saving in: {}'.format(csv_name))
        ...
        config = get_config(args.files,args.landmark)
